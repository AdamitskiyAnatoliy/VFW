...
//@interface Adamitskiy_Anatoliy_Project1Object : NSObject
//@end

@interface Adamitskiy_Anatoliy_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Adamitskiy_Anatoliy_Project1Object class]])
		{
			for (NSString *key in [[(Adamitskiy_Anatoliy_Project1Object*)o modules] allKeys])
			{
