...
//@interface Adamitskiy_Anatoliy_Project2Object : NSObject
//@end

@interface Adamitskiy_Anatoliy_Project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Adamitskiy_Anatoliy_Project2Object class]])
		{
			for (NSString *key in [[(Adamitskiy_Anatoliy_Project2Object*)o modules] allKeys])
			{
