...
@interface Adamitskiy_Anatoliy_Project2Object : KrollCoverageObject {
#else
@interface Adamitskiy_Anatoliy_Project2Object : KrollObject {
#endif
@private
...
extern NSString * Adamitskiy_Anatoliy_Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Adamitskiy_Anatoliy_Project2Object *_adamitskiy_anatoliy_project2;
    KrollObject* console;
	BOOL shutdown;
