...
// in simulator we redefine to format for Adamitskiy_Anatoliy_Project2 Developer console
...
{\
	NSString * exceptionName = [@"org.adamitskiy_anatoliy_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.adamitskiy_anatoliy_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAdamitskiy_Anatoliy_Project2NativeItemNone = -1, 
	UIAdamitskiy_Anatoliy_Project2NativeItemSpinner = -2,
	UIAdamitskiy_Anatoliy_Project2NativeItemProgressBar = -3,
	
	UIAdamitskiy_Anatoliy_Project2NativeItemSlider = -4,
	UIAdamitskiy_Anatoliy_Project2NativeItemSwitch = -5,
	UIAdamitskiy_Anatoliy_Project2NativeItemMultiButton = -6,
	UIAdamitskiy_Anatoliy_Project2NativeItemSegmented = -7,
	
	UIAdamitskiy_Anatoliy_Project2NativeItemTextView = -8,
	UIAdamitskiy_Anatoliy_Project2NativeItemTextField = -9,
	UIAdamitskiy_Anatoliy_Project2NativeItemSearchBar = -10,
	
	UIAdamitskiy_Anatoliy_Project2NativeItemPicker = -11,
	UIAdamitskiy_Anatoliy_Project2NativeItemDatePicker = -12,
	
	UIAdamitskiy_Anatoliy_Project2NativeItemInfoLight = -13,
	UIAdamitskiy_Anatoliy_Project2NativeItemInfoDark = -14,
	
	UIAdamitskiy_Anatoliy_Project2NativeItemDisclosure = -15,
	
	UIAdamitskiy_Anatoliy_Project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Adamitskiy_Anatoliy_Project2 instances of
