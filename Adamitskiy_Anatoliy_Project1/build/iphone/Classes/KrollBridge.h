...
@interface Adamitskiy_Anatoliy_Project1Object : KrollCoverageObject {
#else
@interface Adamitskiy_Anatoliy_Project1Object : KrollObject {
#endif
@private
...
extern NSString * Adamitskiy_Anatoliy_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Adamitskiy_Anatoliy_Project1Object *_adamitskiy_anatoliy_project1;
    KrollObject* console;
	BOOL shutdown;
