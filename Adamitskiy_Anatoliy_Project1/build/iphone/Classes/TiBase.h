...
// in simulator we redefine to format for Adamitskiy_Anatoliy_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.adamitskiy_anatoliy_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.adamitskiy_anatoliy_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAdamitskiy_Anatoliy_Project1NativeItemNone = -1, 
	UIAdamitskiy_Anatoliy_Project1NativeItemSpinner = -2,
	UIAdamitskiy_Anatoliy_Project1NativeItemProgressBar = -3,
	
	UIAdamitskiy_Anatoliy_Project1NativeItemSlider = -4,
	UIAdamitskiy_Anatoliy_Project1NativeItemSwitch = -5,
	UIAdamitskiy_Anatoliy_Project1NativeItemMultiButton = -6,
	UIAdamitskiy_Anatoliy_Project1NativeItemSegmented = -7,
	
	UIAdamitskiy_Anatoliy_Project1NativeItemTextView = -8,
	UIAdamitskiy_Anatoliy_Project1NativeItemTextField = -9,
	UIAdamitskiy_Anatoliy_Project1NativeItemSearchBar = -10,
	
	UIAdamitskiy_Anatoliy_Project1NativeItemPicker = -11,
	UIAdamitskiy_Anatoliy_Project1NativeItemDatePicker = -12,
	
	UIAdamitskiy_Anatoliy_Project1NativeItemInfoLight = -13,
	UIAdamitskiy_Anatoliy_Project1NativeItemInfoDark = -14,
	
	UIAdamitskiy_Anatoliy_Project1NativeItemDisclosure = -15,
	
	UIAdamitskiy_Anatoliy_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Adamitskiy_Anatoliy_Project1 instances of
