...
/**
 The base class for all Adamitskiy_Anatoliy_Project4 modules
 */
...
/**
 Adamitskiy_Anatoliy_Project4 Platform calls this method on startup.
 */
-(void)startup;

/**
 Adamitskiy_Anatoliy_Project4 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Adamitskiy_Anatoliy_Project4 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Adamitskiy_Anatoliy_Project4 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Adamitskiy_Anatoliy_Project4 Platform calls this method on resume.
 @param sender The sender of the event.
 */
