...
// in simulator we redefine to format for Adamitskiy_Anatoliy_Project4 Developer console
...
{\
	NSString * exceptionName = [@"org.adamitskiy_anatoliy_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.adamitskiy_anatoliy_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAdamitskiy_Anatoliy_Project4NativeItemNone = -1, 
	UIAdamitskiy_Anatoliy_Project4NativeItemSpinner = -2,
	UIAdamitskiy_Anatoliy_Project4NativeItemProgressBar = -3,
	
	UIAdamitskiy_Anatoliy_Project4NativeItemSlider = -4,
	UIAdamitskiy_Anatoliy_Project4NativeItemSwitch = -5,
	UIAdamitskiy_Anatoliy_Project4NativeItemMultiButton = -6,
	UIAdamitskiy_Anatoliy_Project4NativeItemSegmented = -7,
	
	UIAdamitskiy_Anatoliy_Project4NativeItemTextView = -8,
	UIAdamitskiy_Anatoliy_Project4NativeItemTextField = -9,
	UIAdamitskiy_Anatoliy_Project4NativeItemSearchBar = -10,
	
	UIAdamitskiy_Anatoliy_Project4NativeItemPicker = -11,
	UIAdamitskiy_Anatoliy_Project4NativeItemDatePicker = -12,
	
	UIAdamitskiy_Anatoliy_Project4NativeItemInfoLight = -13,
	UIAdamitskiy_Anatoliy_Project4NativeItemInfoDark = -14,
	
	UIAdamitskiy_Anatoliy_Project4NativeItemDisclosure = -15,
	
	UIAdamitskiy_Anatoliy_Project4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Adamitskiy_Anatoliy_Project4 instances of
