...
@interface Adamitskiy_Anatoliy_Project4Object : KrollCoverageObject {
#else
@interface Adamitskiy_Anatoliy_Project4Object : KrollObject {
#endif
@private
...
extern NSString * Adamitskiy_Anatoliy_Project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Adamitskiy_Anatoliy_Project4Object *_adamitskiy_anatoliy_project4;
    KrollObject* console;
	BOOL shutdown;
