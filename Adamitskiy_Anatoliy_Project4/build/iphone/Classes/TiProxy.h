...
//Rare exceptions to indicate a bug in the _adamitskiy_anatoliy_project4 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Adamitskiy_Anatoliy_Project4 proxies.
 */
