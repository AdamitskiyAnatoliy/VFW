...
//@interface Adamitskiy_Anatoliy_Project4Object : NSObject
//@end

@interface Adamitskiy_Anatoliy_Project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Adamitskiy_Anatoliy_Project4Object class]])
		{
			for (NSString *key in [[(Adamitskiy_Anatoliy_Project4Object*)o modules] allKeys])
			{
