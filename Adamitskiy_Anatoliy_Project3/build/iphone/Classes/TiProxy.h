...
//Rare exceptions to indicate a bug in the _adamitskiy_anatoliy_project3 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Adamitskiy_Anatoliy_Project3 proxies.
 */
