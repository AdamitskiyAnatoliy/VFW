...
/**
 Base class for all Adamitskiy_Anatoliy_Project3 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Adamitskiy_Anatoliy_Project3 view hierarchy (such as wrapped iOS UIViews) was touched.
