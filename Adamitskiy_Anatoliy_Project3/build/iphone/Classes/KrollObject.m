...
//@interface Adamitskiy_Anatoliy_Project3Object : NSObject
//@end

@interface Adamitskiy_Anatoliy_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Adamitskiy_Anatoliy_Project3Object class]])
		{
			for (NSString *key in [[(Adamitskiy_Anatoliy_Project3Object*)o modules] allKeys])
			{
