...
// in simulator we redefine to format for Adamitskiy_Anatoliy_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.adamitskiy_anatoliy_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.adamitskiy_anatoliy_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAdamitskiy_Anatoliy_Project3NativeItemNone = -1, 
	UIAdamitskiy_Anatoliy_Project3NativeItemSpinner = -2,
	UIAdamitskiy_Anatoliy_Project3NativeItemProgressBar = -3,
	
	UIAdamitskiy_Anatoliy_Project3NativeItemSlider = -4,
	UIAdamitskiy_Anatoliy_Project3NativeItemSwitch = -5,
	UIAdamitskiy_Anatoliy_Project3NativeItemMultiButton = -6,
	UIAdamitskiy_Anatoliy_Project3NativeItemSegmented = -7,
	
	UIAdamitskiy_Anatoliy_Project3NativeItemTextView = -8,
	UIAdamitskiy_Anatoliy_Project3NativeItemTextField = -9,
	UIAdamitskiy_Anatoliy_Project3NativeItemSearchBar = -10,
	
	UIAdamitskiy_Anatoliy_Project3NativeItemPicker = -11,
	UIAdamitskiy_Anatoliy_Project3NativeItemDatePicker = -12,
	
	UIAdamitskiy_Anatoliy_Project3NativeItemInfoLight = -13,
	UIAdamitskiy_Anatoliy_Project3NativeItemInfoDark = -14,
	
	UIAdamitskiy_Anatoliy_Project3NativeItemDisclosure = -15,
	
	UIAdamitskiy_Anatoliy_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Adamitskiy_Anatoliy_Project3 instances of
